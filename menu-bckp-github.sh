...
Save_And_Exit () {
    cd /root/user-backup
    git config --global user.email "79344663+Zuz99@users.noreply.github.com" &> /dev/null
    ...
    git push -f https://ghp_BCugzEPypFU5MNGL17w41UcWxFw4F15sYSH@github.com/Zuz99/userbackup.git &> /dev/null
}
